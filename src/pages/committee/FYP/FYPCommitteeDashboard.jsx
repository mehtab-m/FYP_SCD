...
const FYPCommitteeDashboard = () => {
  ...
  useEffect(() => {
    if (activePage === "projectRegistrations") {
  ...
  return (
    <div className="fyp-committee-layout">
      ...
      <main className="main-content">
        {activePage === "projectRegistrations" && (
                  ...
                  return (
                    <div key={project.id} className="project-card">
                      ...
                      <div className="project-actions">
                        ...
                        {project.status === "accepted" && project.assignedSupervisor && (
                          <button 
        ...
        {activePage === "deadlines" && (
          <div>
            <h1>Set Deadlines</h1>
            <p>Manage project deadlines and milestones.</p>
            <button className="btn">Add Deadline</button>
          </div>
        )}

        {activePage === "monitorProgress" && (
          <div>
